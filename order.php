	 ...
	 <a href="orders.php"><div class="col-md-3 col-lg-3 col-sm-3 col-xs-3 element"><span class="menu reparing">Orders</span></div></a>
    	...
    	<div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 product">
                	...
                	<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 mystruct text-center"  >
						<div class="col-md-11 myslide"  >
							<img src="<?php echo $myimg ?>">
						    <h2><?php echo $name; ?></h2>
						    <p><del><?php echo "RS. ".$mrate; ?></del>
                            <?php echo "RS. ".$orate; ?></p>
                            <?php echo "Details : ".$info; ?></p>
                    ...
                    <div class="col-md-8 col-lg-8 " >
                    	...
                    	<form method="GET" action="orderme.php">
                    		...
                    		<h2 class=" text-center">Conform Your Order</h2>
					   		...
					   		<input type="hidden" name="total" value="<?php echo $orate ; ?>">
					   		
					   		<div class="form-group mt-3 col-md-6">
								<label for="address">House No:</label>
								<input type="text" class="form-control" id="address" placeholder="Enter the House No." name="address" required />
							</div>	
							<div class="form-group mt-3 col-md-6">
								<label for="address">Street:</label>
								<input type="text" class="form-control" id="address" placeholder="Enter the Street" name="address2" required />
							</div>	
							<div class="form-group mt-3 col-md-6">
								<label for="address">City:</label>
								<input type="text" class="form-control" id="address" placeholder="Enter the City" name="address3" required />
							</div>	
							<div class="form-group mt-3 col-md-6">
								<label for="address">State:</label>
								<input type="text" class="form-control" id="address" placeholder="Enter the State" name="address4" required />
							</div>
							<div class="form-group mt-3 col-md-6">
								<label for="address">Postal Code:</label>
								<input type="text" class="form-control" id="address" placeholder="Enter the Postal Code" name="address5" required />
							</div>
							<div class="form-group mt-3 col-md-6">
								<label for="address">Conuntry:</label>
								<input type="text" class="form-control" id="address" placeholder="Enter the Country" name="address6" required />
							</div>	

							<div class="text-center">
								<input type="submit" name="btn" value="Buy" class="btn btn-primary col-md-4" />
							</div>
