			...
			<div class="bdy">
				<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 product text-center">
					...
					<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" >
						<a href="food.php">
						<div class="slides ">
							<h1 style="align-self: center; font-weight: bold;">Food</h1>
					...
					<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
						<a href="kitchen.php">
						<div class="slides" >
							<h1 style="align-self: center; font-weight: bold;" >Kitchen</h1>
					...
					<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
						<a href="hygiene.php">
						<div class="slides" >
							<h1 style="align-self: center; font-weight: bold;">Hygiene</h1>
