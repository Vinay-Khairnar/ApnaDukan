...
<div class="container-fluid">
        ...
        <a href="profile.php"> <div class="col-md-2 col-lg-2 col-xs-3 text-center text-center send" >
                <?php 
                    ...
                    ?></div></a>  			
            <div class="col-md-8 col-lg-8 col-xs-6 text-center title">Apna Dukan</div>
	...
	<div class="container">
		...
		<div class="jumbotron" style="margin-top: 120px;">	
			<h2 class="jumbotron text-center">
				...
				Please Complete the Transaction by UPI Payment <br>
				<br>
				Rs. <?php echo $total; ?> 
			</h2>
			...
			<div class="row">
				...
				<div class="col-md-6 text-center">
					<img src="./images/qrcode.jpg" width="200px" alt="">
					<p class="text-center"> Scan QR </p>
					<br><br><br><br><br>

				</div>
				<div class="col-md-6 text-center">
					<a href="upi://pay?pa=9284969013@apl&pn=Apna Dukan&am=<?php echo $total; ?>&cu=INR">
						<img src="./images/upi.png" width="200px" alt="">
						<p class="text-center"> Click Here to pay by UPI</p>
					</a>
					<br><br><br><br><br>
				</div>
...
<br><br><br><br><br><br><br><br>
				...
				<footer class="footer">
					<a href="index.php">
					<div class="col-md-3 col-lg-3 col-xs-3 ftr">
