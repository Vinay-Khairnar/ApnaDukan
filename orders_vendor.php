...
<div class="container-fluid">
        ...
        <a href="profile.php"> <div class="col-md-2 col-lg-2 col-xs-3 text-center text-center send" >
			...
			<a href="vupload.php"><div class="col-md-2 col-lg-2 col-xs-3  text-center  cart"> GoBack </div></a>
...
<a href="food.php"><div class="col-md-3 col-lg-3 col-sm-3 col-xs-3  element"><span class="menu shirt">Food</span> </div></a>
	 ...
	 <a href="orders.php"><div class="col-md-3 col-lg-3 col-sm-3 col-xs-3 element"><span class="menu reparing">Orders</span></div></a>
		...
		<div class="col-md-12 product">
            ...
            $sql = "Select * from orders where vuser='$user' "; 	            
            ...
            $sql = "Select * from vendor_$user where id='$pid' "; 	            
