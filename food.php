...
<div class="row">
        ...
        <a href="profile.php"> <div class="col-md-2 col-lg-2  col-s-3 col-xs-3 text-center text-center send" >
                <?php 
                    ...
                    ?></div></a>  			
            <div class="col-md-8 col-lg-8 col-sm-6 col-xs-6 text-center title">ApnaDukan</div>
...
<br><br><br><br><br><br><br><br>
				...
				<footer class="footer">
					<a href="index.php">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ftr">
