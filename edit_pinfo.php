...
<div class="container-fluid">
    ...
    <input type="radio" id="food" name="field" value="food">
      <label for="food">Food</label><br>

      <input type="radio"  id="tech" name="field" value="kitchen">
      <label for="kitchen">Kitchen</label><br>

      <input type="radio"  id="hygiene" name="field" value="hygiene">
