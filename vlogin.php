...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="index.php">Apna Dukan</a>
    </div>
  </div>
</nav>
    ...
    <div class="col-md-1 col-lg-1 col-xs-0"></div>
      <div class="col-md-4 col-lg-4 col-xs-12 jumbotron">
        <form method="POST" action="vlogme1.php">
    <div class="form-group">
        <h3 style ="align:center">Vendor <u> Login</u></h3>
      <label for="name">Userame:</label>
      <input type="text" class="form-control" id="name" placeholder="Enter the Full name " name="username" required>
 </div>
    <div class="form-group">
    ...
    <button type="submit" class="btn btn-primary" name="sub">Login</button>
      ...
      <div class="col-lg-5 col-md-5 col-xs-12 jumbotron" >
        <h3 align="center">Vendors <u> Signup</u></h3>

        <form method="GET" action="vlogme.php">
    <div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="contact" placeholder="Enter The Contact Number " name="contact" required>
    </div>
    <div class="form-group">
      <label for="password">Password:</label>
      <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="password" required>
