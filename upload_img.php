...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="upload_img.php">Upload Home Page Images </a></li>
                ...
                <div class="col-md-3 mystruct text-center" >
						...
						<img src="<?php echo $myimg ?>">
						    ...
						    <form method="POST" enctype="multipart/form-data" class="col-md-12">
								...
								<input type="submit" name="submit" value="Upload Image" class=" btn btn-primary " style="margin-top: 50px;" />
							</form>
...
$sql = "update vendor_$user SET image='$image' where id=$id ";
$result=mysqli_query($conn,$sql);
